...
namespace SongRequestManagerV2
{
    public partial class RequestBot// : MonoBehaviour
    {
        ...
        private void Addtolist(IChatUser requestor, string request)
        {
        ...
        private void ListList(IChatUser requestor, string request)
        {
            try
            {
        ...
        private void RemoveFromlist(IChatUser requestor, string request)
        {
            string[] parts = request.Split(new char[] { ' ', ',' }, 2);
            if (parts.Length < 2)
            {
        ...
        private void ClearList(IChatUser requestor, string request)
        {
            try
            {
        ...
        private void UnloadList(IChatUser requestor, string request)
        {
            try
            {
        ...
        private void writelist(IChatUser requestor, string request)
        {
        ...
        private void OpenList(IChatUser requestor, string request)
        {
        ...
        public class StringListManager
        {
            ...
            public void runscript()
            {
                try
                {
                    ...
                    foreach (var line in list) COMMAND.Parse(null, line, RequestBot.CmdFlags.Local);
                }
                catch (Exception ex)
                {
